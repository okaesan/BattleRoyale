...
public class PlusDeathArea {
  ...
  public static int betaLx;
  public static int betaLz;
  public static int betaRx;
  public static int betaRz;
...
class PlusThreadClass extends BukkitRunnable {
  ...
  public void run() {
    ...
    if (loopC == 30) {
      ...
      // Bukkit.broadcastMessage(BattleRoyale.prefix + ChatColor.RED + "30秒後" + ChatColor.GRAY
      // + "に禁止区域が追加されます。");
      MainUtils.sendTitleToEveryone(ChatColor.RED + "30秒後", ChatColor.WHITE + "禁止区域が追加されます。", 1, 3,
          1);
      count++;
    }
