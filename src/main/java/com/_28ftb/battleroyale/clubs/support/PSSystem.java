...
public class PSSystem extends BattleRoyale {
  ...
  public static Entity ChangingSpeed(Entity entity, double multiplier) {
    ...
    Vector v = new Vector(entity.getVelocity().getX() * multiplier,
        entity.getVelocity().getY() * multiplier, entity.getVelocity().getZ() * multiplier);
  ...
  public static List<LivingEntity> getNearbyEntityAll(Location location, int distance,
      Player player) {
