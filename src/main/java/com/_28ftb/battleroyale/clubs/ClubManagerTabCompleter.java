  ...
  public List<String> onTabComplete(CommandSender sender, Command cmd, String label,
    ...
    if (sender instanceof Player && args.length == 1) {
      if (label.equalsIgnoreCase("clubmanager")) {
        ...
        tab.add("set");
        /*
         * tab.add("debugmode"); tab.add("debugger");
         */
    ...
    if (sender instanceof Player && args.length == 2) {
      if (label.equalsIgnoreCase("clubmanager")) {
        ...
        if (args[0].equals("set") || args[0].equals("remove") || args[0].equals("get")
            || args[0].equals("debugger")) {
        ...
        /*
         * if(args[0].equals("debugmode")){ tab.add("true"); tab.add("false"); }
         */
      }
    }
